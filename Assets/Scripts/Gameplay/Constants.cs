...
public static class Constants
{
    ...
    public const string         c_PlayerCoinsSave = "Coins";
    public const string         c_DailyRewardTimerSave = "Timer";
    public const string         c_DailyRewardDateSave = "Date";
    public const string         c_DaysCollectedSave = "DaysCollected";
    ...
    //Daily Reward
    public const string c_LastRewardTime = "LastRewardTime";
    public const string c_LastReward = "LastReward";
    public const string c_DebugTime = "DebugTime";
    public const string c_FMT = "O";
}
